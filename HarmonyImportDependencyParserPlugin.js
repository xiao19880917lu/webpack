...
module.exports = class HarmonyImportDependencyParserPlugin {
	...
	/** luyongfang 在Parse的时候 解析到import 等变量时增加依赖*/
	/** 
	 * 0. node_modules/webpack/lib/Parser.js在解析AST时碰到import 等var声明时 prewalkImportDeclaration 函数
	 * 1. 调用注册过hooks.import的钩子进行处理，如import添加以来
	 * 2. https://juejin.cn/post/6844903833445859335
	 * 3. https://zhuanlan.zhihu.com/p/102606552 各个依赖的作用
	*/
	apply(parser) {
