...
class NormalModule extends Module {
	...
	createLoaderContext(resolver, options, compilation, fs) {
		...
		/** luyongfang */
		/**
		 * 0. LoaderPlugin 中会调用compilation.compilation.hooks.normalModuleLoader
		*/
	...
	/** luyongfang */
	/**
	 * 0. createLoaderContext 函数中会调用compilation.hooks.normalModuleLoader注册的钩子
	 * 1. 在loaderPlugin中注册的这个钩子: 会注入loadModule函数来给compilation.addModuleDependencies 增加依赖
	*/
		...
		runLoaders(
			...
			(err, result) => {
				if (result) {
					...
					/** luyongfang doBuild时可以拿到 buildInfo.fileDependencies*/
