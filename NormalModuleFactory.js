...
class NormalModuleFactory extends Tapable {
	constructor(context, resolverFactory, options) {
		...
		/** luyongfang 实例化的时候，注册在factory上事件名为NormalModuleFactory的事件 */
		/** 调用this.hooks.factory.call 的时候-即NormalModuleFactory.create函数中调用 */
			...
			resolver(result, (err, data) => {
				...
				this.hooks.afterResolve.callAsync(data, (err, result) => {
					...
					if (!createdModule) {
						...
						/** luyongfang 解析到资源的路径后实例化normalModule*/
